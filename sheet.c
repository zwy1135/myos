...
struct SHTCTL *shtctl_init(struct MEMMAN *memman,unsigned char *vram,int xsize,int ysize)
{
	...
	if(ctl == 0)
		goto err;
	ctl->map = memman_alloc_4k(memman,xsize * ysize);
	if(ctl == 0)
	{
...
void sheet_refreshsub(struct SHTCTL *ctl,int vx0,int vy0,int vx1,int vy1,int h0,int h1)		//刷新bx0,by0到bx1,by1的范围
{
...
void sheet_refreshmap(struct SHTCTL *ctl,int vx0,int vy0,int vx1,int vy1,int h0)		//做出bx0,by0到bx1,by1的图层分布图
{
	int h,bx,by,vx,vy,bx0,by0,bx1,by1;
